...
def visualize_files(input_file: str, output_file: str, test_case: str):
...
def visualize_testcase_id(test_case_id: int):
    ...
    print(f"[{test_case_id}] {test_case}: {input_file} → {output_file}")
    visualize_files(input_file, output_file, test_case)

def visual_all_cases():
    for i in range(12):
        visualize_testcase_id(i)
